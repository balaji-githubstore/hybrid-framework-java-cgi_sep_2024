...
public class EmployeeSteps {
	...
	public void i_click_on_pim_menu() {
		AutomationWrapper.driver.findElement(By.xpath("//*[text()='PIM']")).click();
	}
	@When("I click on Add Employee menu")
	public void i_click_on_add_employee_menu() {
		AutomationWrapper.driver.findElement(By.xpath("//*[text()='Add Employee']")).click();
	}
	...
	public void i_fill_the_employee_detail(DataTable dataTable) {
		...
		AutomationWrapper.driver.findElement(By.name("firstname")).sendKeys(lists.get(0).get("firstname"));
